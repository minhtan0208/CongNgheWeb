							...
							<div class="cart_login">
								<div class="title_cart">
									...
									<form action="payment.php" method="POST">
										<div class="form-group">
										    <label for="exampleInputEmail1">Thay đổi thông tin người mượn tại đây :</label>
										    <textarea class="form-control" name="info_receive"><?php if(isset($info_receive)){ echo $info_receive; } ?></textarea>
										</div>
										<div class="form-group">
										    <label for="exampleInputPassword1">Thông tin sản phẩm (Tên tác giả , Năm sản xuất, ID sách ) :</label>
										    <textarea class="form-control" name="info_product"><?php if(isset($info_product)){ echo $info_product; } ?></textarea>
										</div>
										<button type="submit" class="btn btn-primary" name="payment_cart">Mượn sách</button>
									</form>
								</div>
							</div>
							<!-- cart empty products -->
