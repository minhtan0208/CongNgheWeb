                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Tất cả khách hàng mượn sách trong ngày
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                {
                                                                    echo "<span class='badge-dot badge-brand mr-1'></span>Đang mượn";
                                                                }
                                                                else if($row_invoice['flag'] == 2)
                                                                {
                                                                    echo "<span class='badge-dot badge-success mr-1'></span>Trả thành công";
                                                                }
