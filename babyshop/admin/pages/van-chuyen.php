                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                   <i class="fas fa-file-invoice"></i> Mã sách: 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10" style="text-align:  justify;">
                                            ...
                                            <p style="font-family: 'Roboto Condensed', sans-serif; margin-top: -15px;">Ghi chú sản phẩm: <b> <?php echo $row_invoice['info_product']; ?></b><p>
                                        </div>
                                        <!-- col-lg-10 -->
                                    </div>
                                    <!-- row -->
