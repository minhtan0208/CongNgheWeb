<?php 
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        if(isset($_GET['confirm']))
        {
            ...
            // insert to history
            $text = " đã xác nhận mượn sách <b>". $code_invoice . "</b>";
...
<body>
        ...
        <div class="dashboard-wrapper">
            ...
            ?>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Chi tiết sách mượn
                                </h5>
                                <div class="card-body">
                                        ...
                                        <table class="table">
                                            <thead class="bg-light">
                                                <tr class="border-0">
                                                    ...
                                                    <th class="border-0" style="font-family: 'Roboto Condensed', sans-serif;">Ảnh sách</th>
                                                    <th class="border-0" style="font-family: 'Roboto Condensed', sans-serif;">Tên sách</th>
